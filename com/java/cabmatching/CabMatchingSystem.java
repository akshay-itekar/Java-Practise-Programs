...
class Driver {
    ...
    Driver(String name, int locationX, int locationY, String cabType) {
        this.name = name;
...
public class CabMatchingSystem {
    public static void main(String[] args) {
        ...
        availableDrivers.add(new Driver("d1", 1, 0, "Hatchback"));
        availableDrivers.add(new Driver("d2", 2, 0, "Sedan"));
        availableDrivers.add(new Driver("d3", 3, 0, "SUV"));
        availableDrivers.add(new Driver("d4", 4, 0, "Sedan"));
    ...
    private static void printDriverDetails(List<Driver> drivers) {
        for (Driver driver : drivers) {
            System.out.println("Driver: " + driver.name + ", Cab Type: " + driver.cabType +
                    ", Distance to Passenger: " + calculateDistance(driver.locationX, driver.locationY, 1, 0));
        }
    }
}
